...
module.exports = function(app, passport) {
    ...
    app.get('/admin', x.loginM, function(req, res) {
        ...
        if (a.administrator != 1) {
            ...
            var connectuser = req.session.userlogin + 'connect';
            connection[connectuser].view.list(function(error, data){
                res.render('admin', { 'name': req.session.userlogin, 'content': req.user, 'administrator': a.administrator , 'listuserload': data});
            });
        }
    });

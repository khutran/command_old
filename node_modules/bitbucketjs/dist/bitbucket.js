...
},{"./repo":3,"./snippet":4,"./team":5,"./user":6,"debug":8,"lodash.get":12,"superagent":17,"superagent-promise":16,"url-join":18}],2:[function(require,module,exports){
'use strict';
...
},{"lodash.get":12}],3:[function(require,module,exports){
'use strict';
...
},{"./decorators":2,"debug":8,"url-join":18}],4:[function(require,module,exports){
'use strict';
...
},{"./decorators":2,"debug":8,"url-join":18}],5:[function(require,module,exports){
'use strict';
...
},{"./decorators":2,"debug":8,"url-join":18}],6:[function(require,module,exports){
'use strict';
...
module.exports = function (opts) {
  ...
  return {
    fetch: function fetch(username) {
      return request.get((0, _urlJoin2['default'])(opts.apiRoot, path, username));
    },

    followers: function followers(username) {
      return request.get((0, _urlJoin2['default'])(opts.apiRoot, path, username, 'followers'));
    }
  };
};

},{"debug":8,"url-join":18}],7:[function(require,module,exports){
...
},{"lodash.isarray":13}],12:[function(require,module,exports){
/**
...
},{"lodash._baseget":10,"lodash._topath":11}],13:[function(require,module,exports){
/**
...
},{"emitter":7,"reduce":15}],18:[function(require,module,exports){
...
exports['default'] = _bitbucket2['default'];
